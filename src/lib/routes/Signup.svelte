...
<div class="bg-slate-800 flex text-white h-screen p-5 justify-center">
  <div class="md:flex bg-slate-900 rounded-lg p-10 h-fit w-fit shadow-lg">
    <div class="flex pl-5 pr-10 items-center">
